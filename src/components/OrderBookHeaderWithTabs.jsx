// src/components/OrderBookHeaderWithTabs.jsx
...
/**
 * Props:
 * - active: "orders" | "add" | "sold" | "stats" | "database"
 * - showTabs: boolean (default true)
 * - showHubTab: boolean (default false) - adds Hub tab as first tab
 */
export default function OrderBookHeaderWithTabs({ active = "", showTabs = true, showHubTab = false }) {
